...
describe('dashboard service tests', () => {
  ...
  describe('usersWithOrders tests', () => {
  ...
  describe('userClosedOrders tests', () => {
    it('should have a userClosedOrders method', () => {
      expect(dashboard.userClosedOrders).toBeDefined();
    });

    it('get all user closed orders', async () => {
      const result = await dashboard.userClosedOrders('1');
      expect(result).toEqual([
        {
          id: 2,
          user_id: '1',
  ...
  describe('userOpenOrders tests', () => {
    it('should have a userOpenOrders method', () => {
      expect(dashboard.userOpenOrders).toBeDefined();
    });

    it('get all user open orders', async () => {
      const result = await dashboard.userOpenOrders('1');
      expect(result).toEqual([
        {
          id: 1,
          user_id: '1',
  ...
  describe('Books Category tests', () => {
    it('should have a book_Category method', () => {
      expect(dashboard.books_category).toBeDefined();
    });
  ...
  describe('Books in order tests', () => {
    it('should have a booksInOrders method', () => {
      expect(dashboard.booksInOrders).toBeDefined();
    });

    it('get all books in order', async () => {
      const result = await dashboard.booksInOrders();
      expect(result).toEqual([
        {
          title: 'Alice in Wonderland',
          price: 5,
  ...
  describe('5 most expensive books tests', () => {
    it('should have a fiveMostExpensiveBooks method', () => {
      expect(dashboard.fiveMostExpensiveBooks).toBeDefined();
    });

    it('get the 5 most expensive books from the store', async () => {
      const result = await dashboard.fiveMostExpensiveBooks();
      expect(result).toEqual([
        {
          title: 'The Odyssey',
          price: 40
  ...
  describe('5 most popular books tests', () => {
    it('should have a getMostPopularBooks method', () => {
      expect(dashboard.getMostPopularBooks).toBeDefined();
    });

    it('get the 5 most popular books from the store', async () => {
      const result = await dashboard.getMostPopularBooks();
      expect(result).toEqual([
        {
          book_id: '2',
          title: '3 men in a boat',
